...
const addMethod = "autocount.autocount.doctype.autocount_quotation.autocount_quotation.add";
const editMethod = "autocount.autocount.doctype.autocount_quotation.autocount_quotation.edit";
...
frappe.ui.form.on('Autocount Quotation', {
	...
	debtor_code: function(frm) {
		...
		frappe.call({
			...
			callback:function(r){
				var credit_term = r.message.credit_term;
				frm.set_value("credit_term", credit_term);
			},
		});
	},
