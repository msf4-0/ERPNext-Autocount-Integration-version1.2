...
const addMethod = "autocount.autocount.doctype.autocount_sales_order.autocount_sales_order.add";
const editMethod = "autocount.autocount.doctype.autocount_sales_order.autocount_sales_order.edit";
...
frappe.ui.form.on('Autocount Sales Order', {
