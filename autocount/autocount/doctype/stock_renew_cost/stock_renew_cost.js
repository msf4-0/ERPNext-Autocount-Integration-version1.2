...
const addMethod = "autocount.autocount.doctype.stock_renew_cost.stock_renew_cost.add";
const editMethod = "autocount.autocount.doctype.stock_renew_cost.stock_renew_cost.edit";

frappe.ui.form.on('Stock Renew Cost', {
...
frappe.ui.form.on('Update Cost Child Table', {
